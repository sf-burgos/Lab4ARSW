...
public class InMemoryPersistenceTest {
    ...
    @Test
    public void DeberiaDeFuncionarGetBluePrint() {
        InMemoryBlueprintPersistence ibpp = new InMemoryBlueprintPersistence();
        Point[] pts = new Point[]{
        ...
        Blueprint prueba = null;
        try {
            prueba = ibpp.getBlueprint("john", "thepaint");
        } catch (BlueprintNotFoundException e) {
            fail("Blueprint persistence failed searching the blueprint.");
        }
        assertEquals(bp, prueba);


    }
    @Test
    public void DeberiaDeFuncionarGetBluePrintByAutor() {
        InMemoryBlueprintPersistence ibpp = new InMemoryBlueprintPersistence();
        ...
        try {
            ...
            ibpp.saveBlueprint(bp2);
            prueba.add(bp2);
            assertEquals(prueba, ibpp.getBlueprintsByAuthor("john"));
